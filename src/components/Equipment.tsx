  ...
  return (
    <section id="equipamentos" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3 gap-8 items-center md:items-start">
          {filteredEquipment.map((item) => (
            <div
              key={item.id}
              className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all transform hover:-translate-y-2 border border-gray-200 w-full h-full md:w-auto md:h-auto"
              style={{
                maxWidth: '400px',
                minHeight: '240px',
              }}
            >
              <div className="relative h-60 md:h-auto overflow-hidden bg-gray-200">
                <img
                  src={item.image_url}
                  alt={item.name}
              ...
              <div className="p-6">
                <div className="text-sm text-[#874234] font-semibold mb-2">{item.category}</div>
                <h3 className="text-xl font-bold text-[#2b2220] mb-2">{item.name}</h3>
                ...
                <button
                  ...
                  className="w-full bg-[#d87934] hover:bg-[#874234] text-white px-6 py-3 rounded-lg font-semibold transition-all flex items-center justify-center gap-2"
                >
                  <Phone size={18} />
                  Solicitar Orçamento
                </button>
